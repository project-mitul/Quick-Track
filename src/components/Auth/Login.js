...
//           </div>
//           <svg className="trajectory" width="60" height="20" viewBox="0 0 60 20">
//             <path d="M5,10 Q30,2 55,10" stroke="#3a7d44" strokeWidth="2" strokeDasharray="4 2" fill="none" />
//           </svg>
//         </div>
        
//         <h1>CrickTrack<span className="accent">.ai</span></h1>
//         <p className="tagline">AI-Powered Ball Tracking</p>
...
//             <svg viewBox="0 0 24 24" width="18" height="18">
//               <path fill="currentColor" d="M21.35,11.1H12v3.2h5.59c-0.25,1.45-1.67,4.35-5.59,4.35c-3.36,0-6.1-2.79-6.1-6.21s2.74-6.21,6.1-6.21c1.92,0,3.2,0.82,3.93,1.52L18,5.68C16.3,4.11,14.26,3.1,12,3.1C7.05,3.1,3,7.15,3,12.1s4.05,9,9,9c5.19,0,8.65-3.65,8.65-8.79C20.65,11.83,21.1,11.1,21.35,11.1z"/>
//             </svg>
//             <span>Google</span>
//           </button>
...
//                   </svg>
//                 </div>
//                 <span className="stitch-line"></span>
